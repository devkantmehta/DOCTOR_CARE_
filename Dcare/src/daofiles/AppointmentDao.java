...
public class AppointmentDao {
	 ...
	 public static int save(AppointmentBean ab){  
	        ...
	        try{  
	            ...
	            ps.setString(4,ab.getContact());
	            ps.setInt(5, ab.getAge());
	            ps.setString(6, ab.getDay());
	            ps.setString(7,ab.getSpecialty());  
	            ps.setString(8,ab.getDescription());
	            ps.setInt(9, ab.getId());
